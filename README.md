<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/hero.webp?raw=true">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/hero-white.webp?raw=true">
    <img alt="surreal-better-auth banner" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/hero.webp?raw=true">
  </picture>
</p>

<h1 style="margin-top:40px;display:flex;align-content:center;"> 

# <img width="38" height="38" alt="surrealdb better auth adapter icon" align="center" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/atom.png?raw=true" /> SurrealDB Adapter for Better Auth </h1>
...
## <img width="32" height="32" align="center" alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/question.png?raw=true" /> Why this adapter?
...
## <img width="32" height="32" align="center"  alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/crown.png?raw=true" /> Key Features
...
## <img width="32" height="32" align="center" alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/requirements.png?raw=true" />  Requirements
...
## <img width="32" height="32" align="center" alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/quick.png?raw=true" />  Quick Start
...
## <img width="32" height="32" align="center" alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/brain.png?raw=true" /> Best Practices & Architecture
...
## <img width="32" height="32" align="center" alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/star.png?raw=true" /> Show Your Support
...
## <img width="32" height="32" align="center"  alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/pullrequest.png?raw=true" /> Development & Testing
...
## <img width="32" height="32" align="center"  alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/rules.png?raw=true" /> Adapter License

`surreal-better-auth` package - MIT License - see [LICENSE](./packages/surreal-better-auth/LICENSE) for details.

---

## <img width="32" height="32" align="center"  alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/external.png?raw=true" /> Links
...
**Made with <img width="32" height="32" align="center"  alt="surrealdb better auth adapter icon" src="https://raw.githubusercontent.com/oskar-gmerek/surreal-better-auth/beta/assets/heart.png?raw=true" /> for the SurrealDB and Better Auth communities**
